...
#----------------------------------------------------------------
puts "> #{journalist.size} journalists in this array"
...
puts "> Sorting array alphabetically ( and non case sensitive) :"
puts journalist_sort
puts ">> Array is sorted alphabetically ( and non case sensitive)"
